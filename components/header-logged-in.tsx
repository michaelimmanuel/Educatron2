...
const HeaderLoggedIn: NextPage = () => {
  return (
<div className="navbar h-[10%] bg-ColorTealish text-ColorWhite rounded-b-2xl fixed top-0 left-0 right-0">
<div className="dropdown mr-4 ml-4">
  ...
  <div className="flex-none">
    ...
    <div className="dropdown dropdown-end">
      <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar mr-5 ml-4">
